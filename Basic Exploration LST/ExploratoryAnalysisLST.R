...
# Author: S. Paltra, contact: paltra@tu-berlin.de; Leonard Stellbrink

raw_data <- readRDS("data/cleaned_data.rds") #read_csv("/Users/sydney/Downloads/twitter_data.csv")
...
educationLevel <- raw_data %>% select(highest_educational_qualification, current_occupation)
educationLevel$highest_educational_qualification <- factor(educationLevel$highest_educational_qualification, levels = c("A levels", "High-school diploma", "Secondary school qualification", "Other"))
...
educationLevel$current_occupation <- factor(educationLevel$current_occupation, levels = c("education", "medical", "student", "pensioner", "sabbatical", "other", "Unwilling to answer"))
