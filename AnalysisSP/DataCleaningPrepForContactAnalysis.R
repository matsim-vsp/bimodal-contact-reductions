...
data_reduced <- raw_data %>% select(gender, highest_educational_qualification, current_occupation, date_f1_inf, date_s2_inf, date_t3_inf, num_c19_infs, year_of_birth, cc_change_during_pandemic, total_hsld_size_persons_under_14, number_of_children_under_18,
