...
ggsave("CollectionViolinplots_agegroups.pdf",  dpi = 500, w = 24, h = 9)
ggsave("CollectionViolinplots_agegroups.png", dpi = 500, w = 24, h = 9)
...
ggsave("NoInfectionsECDF_agegroups.pdf", dpi = 500, w = 21, h = 12) 
ggsave("NoInfectionsECDF_agegroups.png", dpi = 500, w = 21, h = 12) 
